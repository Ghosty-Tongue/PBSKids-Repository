...
function fetch_and_save_episodes($page) {
    ...
    if ($response === FALSE) {
        ...
        foreach ($episodes as $episode) {
            ...
            $show_title = $episode['show']['attributes']['title'];
